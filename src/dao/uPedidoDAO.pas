...
begin
  ...
  try
    ...
    try
      ...
      Q.ParamByName('d').AsDateTime := now;
    ...
    begin
      ...
      try
        Q.Connection := Conn;
        Q.SQL.Text :=
          'INSERT INTO produtos_pedido (numero_pedido, codigo_produto, quantidade, vr_unitario, vr_total) '+
          'VALUES (:n, :p, :q, :u, :t)';
...
begin
  ...
  try
    Q.Connection := Conn;
    Q.SQL.Text :=
      'SELECT * FROM produtos_pedido WHERE numero_pedido = :n ORDER BY autoincrem';
    Q.ParamByName('n').AsInteger := Numero;
    Q.Open;
...
begin
  ...
  try
    ...
    try
      Q.Connection := Conn;
      Q.SQL.Text := 'DELETE FROM produtos_pedido WHERE numero_pedido = :n';
      Q.ParamByName('n').AsInteger := Numero;
      Q.ExecSQL;
    finally
      Q.Free;
